    ...
    <div className="my-24">
      ...
      <div className="relative flex w-full flex-col items-center justify-center overflow-hidden my-4">
        <Marquee pauseOnHover className="[--duration:20s]">
          <i className="devicon-nextjs-original colored text-5xl mx-4"></i>
          ...
          <i className="devicon-docker-plain colored text-5xl mx-4"></i>
          <i className="devicon-mongodb-plain colored text-5xl mx-4"></i>
          <i className="devicon-postgresql-plain colored text-5xl mx-4"></i>
          <i className="devicon-tailwindcss-plain colored text-5xl mx-4"></i>
          <i className="devicon-githubactions-plain colored text-5xl mx-4"></i>
        </Marquee>
